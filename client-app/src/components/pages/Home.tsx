    ...
    <form>
      {props.accessToken === "" ? (
        <div className="form-group">
          ...
          <a href={`https://app.youneedabudget.com/oauth/authorize?client_id=${props.clientId}&redirect_uri=${window.location.href}&response_type=token`} className="btn btn-primary">Authorize This App With YNAB &gt;</a>
        </div>
        ) : (
        <div className="form-group">
